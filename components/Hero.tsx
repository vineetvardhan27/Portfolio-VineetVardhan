      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-surface/60 dark:bg-white/[0.03] border border-border dark:border-white/[0.06] mb-5 text-[12.5px] font-sans font-medium text-text-secondary tracking-[0.01em]">
              <span className="w-1.5 h-1.5 rounded-full bg-success" />
              <span>
                Websites <span className="text-text-muted/60 px-1.5">·</span> Booking Systems{" "}
                <span className="text-text-muted/60 px-1.5">·</span> Business Software
              </span>
            </div>
            ...
            <div className="mt-4 flex items-center gap-2 text-xs sm:text-[13px] font-sans font-normal text-text-muted">
            ...
            <div className="mt-8 pt-5 border-t border-border/80 dark:border-white/[0.06] w-full flex flex-wrap items-center gap-y-3 gap-x-5 sm:gap-x-7 text-xs sm:text-[13px] font-sans font-medium text-text-secondary">
